...
<head>
  ...
  <link href="{{ asset('vendor/latrell/swagger/css/fonts.css') }}" rel='stylesheet' type='text/css'/>
  ...
  <link href="{{ asset('vendor/latrell/swagger/css/screen.css') }}" media='print' rel='stylesheet' type='text/css'/>
  <script src="{{ asset('vendor/latrell/swagger/lib/shred.bundle.js') }}" type="text/javascript"></script>
  ...
  <script src="{{ asset('vendor/latrell/swagger/lib/handlebars-1.0.0.js') }}" type='text/javascript'></script>
  ...
  <script src="{{ asset('vendor/latrell/swagger/lib/swagger.js') }}" type='text/javascript'></script>
  ...
  <div class="swagger-ui-wrap">
    ...
    <form id='api_selector'>
      <div class='input icon-btn'>
        <img id="show-pet-store-icon" src="{{ asset('vendor/latrell/swagger/images/pet_store_api.png') }}" title="Show Swagger Petstore Example Apis">
      </div>
      <div class='input icon-btn'>
        <img id="show-wordnik-dev-icon" src="{{ asset('vendor/latrell/swagger/images/wordnik_api.png') }}" title="Show Wordnik Developer Apis">
      </div>
